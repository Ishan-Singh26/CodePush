...
A. Boss Fighttime limit per test1 secondmemory limit per test256 megabytesinputstandard inputoutputstandard outputYou are fighting a boss with an unknown amount of health. You have a sequence of $$$n$$$ spell cards, where the $$$i$$$-th card deals $$$a_i$$$ damage. You can rearrange your hand and play the cards in any order you choose.
...
OutputFor each test case, output a single integer — the maximum total health the boss can have such that you will defeat him.

ExampleInput
41100410 5 10 1051 2 3 4 567 7 7 7 7 7Output
100351514NoteIn the first test case, you have only $$$1$$$ card. You play it, dealing $$$100$$$ damage.
