...
A. Odd Erasertime limit per test1 secondmemory limit per test256 megabytesinputstandard inputoutputstandard outputGiven an array $$$a_1, a_2, \ldots, a_n$$$, you can apply the following operation any number of times (possibly zero): 

  Choose an integer $$$k \geq 1$$$ such that $$$2k+1 \le m$$$ and $$$2k+1$$$ indices, $$$i_1, i_2, \ldots, i_{2k+1}$$$ ($$$1 \le i_1  \lt  i_2  \lt  \ldots  \lt  i_{2k+1} \le m$$$), where $$$m$$$ is the current length of the array. Then, remove the $$$i_{k+1}$$$-th element from the array.  Note that after any operation, the length of the array is reduced by one, and the rest of the array is concatenated. Let $$$b_1, b_2, \ldots, b_m$$$ be the remaining array after all operations. 

What is the maximum possible value of $$$\gcd(b_1, b_2, \ldots, b_m)$$$, where $$$\gcd$$$ of an array of integers denotes the greatest common divisor (GCD) of them? 
...
ExampleInput
472 4 6 7 8 9 10255 5555541000000 1000 1 1000000000523 32 23 32 23Output
25100000023NoteIn the first test case, the given array is $$$[2, 4, 6, 7, 8, 9, 10]$$$. 
